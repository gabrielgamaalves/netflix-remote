...
export interface Fiber {
  ...
  pendingProps: FiberProps | null; // This type will be more specific once we overload the tag.
  memoizedProps: FiberProps | null; // The props used to create the output.
...
export class FiberElement implements Fiber {
  ...
  constructor(
    ...
    Object.assign(this, this.getFiberFromElement())
  }

  private getFiberFromElement() {
    let target: HTMLElement | null = this.element;
  ...
  get parentOfFiber(): Fiber | null {
    return this.return
  }

  get props(): FiberProps | null {
    return this.memoizedProps
  }
}
